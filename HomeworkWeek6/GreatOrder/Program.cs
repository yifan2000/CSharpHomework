...
public class OrderDetails
{
    ...
    OrderDetails(string NextGoodName, int NextGoodNumber, int NextGoodPrice)
    {
    ...
    public class OrderService
    {
        ...
        // 修改订单
        public void ChangeOrder(int changeNumber, int orderNumber, string clientName, OrderDetails[] orderDetails)
        {
        ...
        //商品名查询
        public void CheckGoodName(string goodName)
        {
            bool exit4 = false;
            foreach (Order TheOrder in orders)
            {
        ...
        //用户名查询
        public void CheckClient(string clientName)
        {
            var n = from TheOrder in orders
